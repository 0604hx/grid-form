...
<script setup>
    ...
    import { buildComponent, triggerLoaded, triggerBeforeSubmit, triggerExtraButtonClick, computeDefaultValue } from '@grid-form/common'

    const emits = defineEmits(["submit", "failed", "inited"])
    ...
    const track = (...ps)=> console.debug("%c[RENDER]", "background:#8c0776;padding:3px;color:white", ...ps)
